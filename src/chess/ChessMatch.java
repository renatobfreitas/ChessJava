...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if(!type.equals("B") && !type.equals("N") && !type.equals("R") &&!type.equals("Q")) {
			throw new InvalidParameterException("Invalipe type for promotion");
		}
	...
	private Piece makeMove(Position source, Position target) {
		...
		//specialmove castiling rook pequeno
		...
		//specialmove castiling rook grande
		if(p instanceof King && target.getColum() == source.getColum() -2) {
	...
	private void validadeSourcePosition(Position position) {
		...
		if(!board.piece(position).insThereAnyPossibleMove()) {
